...
class ReasonCode(StrEnum):
    ...
    AUTHENTICATION_EVIDENCE_MISSING = "AUTHENTICATION_EVIDENCE_MISSING"
    AUTHENTICATION_EVIDENCE_MISMATCH = "AUTHENTICATION_EVIDENCE_MISMATCH"
    AUTHENTICATION_EVIDENCE_EXPIRED = "AUTHENTICATION_EVIDENCE_EXPIRED"
    AUTHENTICATION_EVIDENCE_REPLAY = "AUTHENTICATION_EVIDENCE_REPLAY"
